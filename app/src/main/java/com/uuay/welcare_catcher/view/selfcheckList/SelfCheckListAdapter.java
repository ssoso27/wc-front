...
public class SelfCheckListAdapter extends BaseAdapter implements Filterable {

    private ArrayList<SelfCheckListItem> listItemList = new ArrayList<SelfCheckListItem>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.selfcheck_list_item, parent, false);
        }
        ...
        SelfCheckListItem listViewItem = listItemList.get(position);
    ...
    public void addItem(String title, String desc, String category, String rating, Date registedAt) {
        SelfCheckListItem item = new SelfCheckListItem();
    ...
    public Filter getFilter() {
        if (listFilter == null) {
            listFilter = new SelfCheckListAdapter.ListFilter() ;
        }
    ...
    private class ListFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                ArrayList<SelfCheckListItem> itemList = new ArrayList<SelfCheckListItem>() ;

                for (SelfCheckListItem item : listItemList) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            listItemList = (ArrayList<SelfCheckListItem>) results.values ;
